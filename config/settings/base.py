...
INGESTION_QUEUE_MAX_JOBS_PER_CYCLE = int(os.getenv("INGESTION_QUEUE_MAX_JOBS_PER_CYCLE", "1"))
...
OPS_COMMAND_CENTER_FAST_MODE = _env_bool("OPS_COMMAND_CENTER_FAST_MODE", False)
